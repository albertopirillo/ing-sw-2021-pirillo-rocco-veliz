...
public class ResourceStrategy {
    ...
    public Resource insertMarble(Player player, int position, AbilityChoice choice, int amount1, int amount2) throws InvalidKeyException, NegativeResAmountException, NoLeaderAbilitiesException, InvalidAbilityChoiceException, CostNotMatchingException {
